...
int dequeue_struct(Queue *q, int customer_count) { //dequeue
    ...
    if (t) {
        ...
        switch(menu_id) {
            case 1: strcpy(menu_name, "Pizza"); price = 70 * qty; break;
            case 2: strcpy(menu_name, "Sapaghetti"); price = 2000 * qty; break;
            case 3: strcpy(menu_name, "Pasta"); price = 40 * qty; break;
            case 4: strcpy(menu_name, "French fries"); price = 120 * qty; break;
